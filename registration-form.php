...
<body>
    ...
    <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-4">
                <form method="post" action="php/reg.php" class="d-flex flex-column align-items-center justify-content-center" style="position:relative;">
    ...
    <script type='text/javascript'>
        function checkParams() {
            ...
            if (login.length != 0 && login.length >= 5 && password.length >= 5 && username.length >=3) {
